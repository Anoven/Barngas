...
class MqttClientSensorServer(mqtt.Client):
    ...
    def __init__(self):
        mqtt.Client.__init__(self)
        print("data client")
        self.connect("192.168.0.100", 1972, 60)
        ...
        self.subscribe("237f51cd" , 0)
        self.subscribe("cae8032a",0)
        self.subscribe("7c342c08", 0)
        self.subscribe("439e5d61", 0)
        self.subscribe("337f51ab" , 0)
        self.subscribe("237f52cd" , 0)
        self.message_callback_add("sensor/+", self.on_sensor_data)
        self.message_callback_add("cae7032a",self.on_temp_data)
        self.message_callback_add("cae8032a",self.on_temp_data)
        self.message_callback_add("7c332c08",self.on_rh_data)
        self.message_callback_add("7c342c08",self.on_rh_data)
        self.message_callback_add("339e5d61", self.on_hs_data)
        self.message_callback_add("439e5d61", self.on_hs_data)
        self.message_callback_add("237f51ab", self.on_methane_data)
        self.message_callback_add("337f51ab", self.on_methane_data)
        self.message_callback_add("237f51cd", self.on_carbon_data)
        self.message_callback_add("237f52cd", self.on_carbon_data)
