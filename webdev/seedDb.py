...
c.execute('DELETE FROM sensors WHERE name = "humidity_test_1";')
c.execute('DELETE FROM sensors WHERE name = "temp_test_2";')
c.execute('DELETE FROM sensors WHERE name = "temp_test_1";')
c.execute('DELETE FROM sensors WHERE name = "h2so04_test_1";')
...
c.execute('INSERT INTO sensors VALUES(2083728392, "HUMIDITY", "humidity_test_1", "humidity testing", NOW(), NOW(), 1, 1);')
c.execute('INSERT INTO sensors VALUES(866016609, "HYDROGEN SULFIDE", "h2so04_test_1", "h2s04 testing", NOW(), NOW(), 1, 1);')
c.execute('INSERT INTO sensors VALUES(123123123, "TEMP", "temp_test_2", "temperature testing", NOW(), NOW(), 1, 1);')
